...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet2 | routed | - | 172.31.255.1/31 | default | 9000 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet2 | routed | - | 172.31.255.3/31 | default | 9000 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.1.255.3/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.1.254.3/32 |
| Loopback100 | customerA_VTEP_DIAGNOSTICS | customerA | 10.255.1.3/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 192.1.255.3/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 192.1.254.3/32
!
...
| Vlan3009 |  customerA  |  10.255.251.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 192.0.255.1 | 65002 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
| 192.0.255.2 | 65002 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
| 10.255.251.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | customerA | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| customerA | 192.1.255.3:10 | 10:10 | - | - | learned | 100 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| customerA | 192.1.255.3:10 | connected |
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 192.1.255.0/24 eq 32 |
| 20 | permit 192.1.254.0/24 eq 32 |
...
| -------------- | --------------------- |
| customerA | 10.255.1.3 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf customerA address 10.255.1.3
```
