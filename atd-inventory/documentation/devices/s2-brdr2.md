...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet8 | routed | - | 172.31.255.21/31 | default | 9000 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet8 | routed | - | 172.31.255.23/31 | default | 9000 | False | - | - |
| Ethernet4 | s2 Border Leaf 1 | routed | - | 172.16.200.3/31 | default | 9000 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.1.255.8/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.1.254.7/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 192.1.255.8/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 192.1.254.7/32
!
...
| 192.0.255.8 | 65103 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| customerA | 192.1.255.8:10 | 10:10<br>remote 10:10 | - | - | learned | 100 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| customerA | 192.1.255.8:10 | connected |
...
router bgp 65203
   ...
   neighbor 192.0.255.8 peer group EVPN-OVERLAY-CORE
   ...
   vlan-aware-bundle customerA
      rd 192.1.255.8:10
      rd evpn domain remote 192.1.255.8:10
